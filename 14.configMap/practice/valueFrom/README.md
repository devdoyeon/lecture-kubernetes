...
# dp-web-apaches-5dcfddcb79-4gcdn   1/1     Running   0          6s
# dp-web-apaches-5dcfddcb79-8h5l6   1/1     Running   0          6s
# dp-web-apaches-5dcfddcb79-gvgfm   1/1     Running   0          6s
```
# 4. Pod의 env 확인
```bash
$ kubectl exec dp-web-apaches-57cdffc8ff-7mfph -- env
# PATH=/usr/local/apache2/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# HOSTNAME=dp-web-apaches-5dcfddcb79-4gcdn
# HTTPD_PREFIX=/usr/local/apache2
# HTTPD_VERSION=2.4.63
# HTTPD_SHA256=88fc236ab99b2864b248de7d49a008ec2afd7551e64dce8b95f58f32f94c46ab
# HTTPD_PATCHES=
# ENV_KEYNAME_1=DEBUG       # 이 부분을 확인하면
# ENV_KEYNAME_2=kubernetes  # env가 제대로 적용된 것을 확인할 수 있다.
